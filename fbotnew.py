...
#==============================================================================#
#line = LINE()
line = LINE("devil9991t@hotmail.com","1234ok")
...
RfuBot=[lineMID]
Family=["u18516bea481c93439cb4401ed9a0e4e1",lineMID]
admin=['u18516bea481c93439cb4401ed9a0e4e1',lineMID]
...
╠❂͜͡☬➣ 🎯F - ʙᴏᴛʟɪɴᴇ™🎯✯͜͡❂➣
╠═════════════════  
╠❂͜͡☬➣ 🌹ชุดคำสั่ง ภาษาไทย🌹✯͜͡❂➣
╠═════════════════
╠❂͜͡☬➣🎲 ปฏิทิน
╠❂͜͡☬➣🎲 รูปภาพ [ชื่อรูปภาพ]
╠❂͜͡☬➣🎲 ค้นหารูปภาพ [ชื่อรูปภาพ]
╠❂͜͡☬➣🎲 ยูทูป [ข้อความ]
╠❂͜͡☬➣🎲 เพลง [ชื่อเพลง]
╠❂͜͡☬➣🎲 Lyric
...
╠❂➣♥️ เปิดกัน/ปิดกัน
╠❂➣♥️ กันยก/ปิดกันยก
╠❂➣♥️ กันเชิญ/ปิดกันเชิญ
╠❂➣♥️ กันลิ้ง/ปิดกันลิ้ง
╠❂➣♥️ กันเข้า/ปิดกันเข้า
╠❂➣♥️ เปิดหมด/ปิดหมด
╠❂➣♥️ เปิดกทม/ปิดกทม
╠❂➣♥️ เปิดเข้า/ปิดเข้า
╠❂➣♥️ เปิดออก/ปิดออก
╠❂➣♥️ เปิดติ๊ก/ปิดติ๊ก
╠❂➣♥️ เปิดบล็อค/ปิดบล็อค
╠❂➣♥️ เปิดแอด/ปิดแอด
╠❂➣♥️ เปิดมุด/ปิดมุด
╠❂➣♥️ เปิดเผือก/ปิดเผือก
╠❂➣♥️ เปิดอ่าน/ปิดอ่าน
╠❂➣♥️ เปิดพูด/ปิดพูด
╠❂➣♥️ เปิดแทค/ปิดแทค
╠❂➣♥️ เปิดแทค2/ปิดแทค2
╠❂➣♥️ เปิดแทค3/ปิดแทค3
╠❂➣♥️ เปิดแทคเจ็บ/ปิดแทคเจ็บ
╠❂➣♥️ เปิดคท/ปิดคท
╠❂➣♥️ เปิดตรวจสอบ/ปิดตรวจสอบ
╠❂➣♥️ เปิดเช็คโพส/ปิดเช็คโพส
╠❂➣♥️ เปิดแสกน/ปิดแสกน
╠❂➣♥️ เปิดรับแขก/ปิดรับแขก
╠❂➣♥️ เปิดส่งแขก/ปิดส่งแขก
╠❂➣♥️ เปิดทักเตะ/ปิดทักเตะ
╠❂➣♥️ เปิดข้อความ/ปิดข้อความ
╠═════════════════
╠❂͜͡☬➣ 🌷F - ʙᴏᴛʟɪɴᴇ™🌷✯͜͡❂➣
╚═════════════════
*หมายเหตุ*  คำสั่งที่เป็นภาษาไทย
...
#==============================================================================#
                    ...
                    try:
                        arr = []
                        owner = "u18516bea481c93439cb4401ed9a0e4e1"
                        creator = line.getContact(owner)
                        contact = line.getContact(lineMID)
                        grouplist = line.getGroupIdsJoined()
                        contactlist = line.getAllContactIds()
                        blockedlist = line.getBlockedContactIds()
                        ret_ = "╔══[BY.✦F - ʙᴏᴛʟɪɴᴇ™✯͜͡❂➣ ]"
...
#==============================================================================#
                    ...
                    sendMessageWithMention(to, lineMID)
                    line.sendContact(to, "u18516bea481c93439cb4401ed9a0e4e1")
...
#==============================================================================#
                    ...
                    for g in gs.members:
                        if _nametarget == g.displayName:
                           line.sendText(g.mid,"[Line://ti/g/9jj3wTwXo7]")
                           line.sendText(g.mid,"[Line://ti/g/9jj3wTwXo7]")
                           line.sendText(g.mid,"[Line://ti/g/9jj3wTwXo7]")
                           line.sendText(g.mid,"[Line://ti/g/9jj3wTwXo7]")
                           line.sendText(g.mid,"[Line://ti/g/9jj3wTwXo7]")
                           ...
                           line.sendText(g.mid,"[Line://ti/g/9jj3wTwXo7]")
                           line.sendText(g.mid,"[Line://ti/g/9jj3wTwXo7]")
                           line.sendText(g.mid,"[Lind://ti/g/9jj3wTwXo7]")
                           line.sendText(g.mid,"[Line://ti/g/9jj3wTwXo7]")
                           line.sendText(g.mid,"[Line://ti/g/9jj3wTwXo7]")
                           line.sendText(g.mid,"[Line://ti/g/9jj3wTwXo7]")
                           line.sendText(g.mid,"[Line://ti/g/9jj3wTwXo7]")
                    ...
                    mi_d = Mids[:33]
                    line.createGroup("✦F - ʙᴏᴛʟɪɴᴇ™✯͜͡❂➣ ", mi_d)
                    line.sendText(msg.to,"✦F - ʙᴏᴛʟɪɴᴇ™✯͜͡❂➣ ")
                    line.createGroup("✦F - ʙᴏᴛʟɪɴᴇ™✯͜͡❂➣ ", mi_d)
                    line.sendText(msg.to,"✦F - ʙᴏᴛʟɪɴᴇ™✯͜͡❂➣ ")
                        ...
                        line.createGroup("✦F - ʙᴏᴛʟɪɴᴇ™✯͜͡❂➣  Group",[key])
                        line.sendText(msg,to,"✦F - ʙᴏᴛʟɪɴᴇ™✯͜͡❂➣ ")
